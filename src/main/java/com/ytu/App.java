...
public class App {
    ...
    private static final Path JSON_FILE_NAME = Paths.get(DIR_NAME + "nodejs.json");
    ...
    public static void main(String[] args) throws IOException {
        ...
        long json = JSON_FILE_NAME.toFile().length();
        System.out.println("ORIGINAL FILE LENGTH -> " + json);
        long comp = COMP_FILE_NAME.toFile().length();
        System.out.println("COMP FILE LENGTH -> " + comp);
        zstd(pack);
        gzip(pack);
        Object unpack = JSONCompress.unpack(pack);
    ...
    private static void zstd(String pack) throws IOException {
        ...
        System.out.println("ZSTD FILE LENGTH -> " + ZSTD_FILE_NAME.toFile().length());
    ...
    private static void gzip(String pack) throws IOException {
        ...
        System.out.println("GZIP FILE LENGTH -> " + GZIP_FILE_NAME.toFile().length());
